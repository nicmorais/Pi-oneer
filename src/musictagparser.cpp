...
QString MusicTagParser::getTitle() const
{
    return MusicTagParser::getTitle(m_filePath);
}
...
QString MusicTagParser::getArtist() const
{
    return MusicTagParser::getArtist(m_filePath);
}
...
QString MusicTagParser::getAlbum() const
{
    return MusicTagParser::getAlbum(m_filePath);
}
